...
public class ExportStudentServlet extends HttpServlet {
	//显示的导出表的标题
			private String title="学生列表";
			//导出表的列名
			private String[] rowsName= new String[]{"序号","学号","姓名","密码","年龄","部门","状态"};
...
//			dataList=ex.find();
			...
			for (User userBean : dataList) {
				System.out.println(userBean+"//");
			}
			ExportStudentServlet ex1 = new ExportStudentServlet();
